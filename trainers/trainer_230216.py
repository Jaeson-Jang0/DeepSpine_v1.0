...
class Trainer: 
    ...
    def _train_session(self, session, x):
        ...
        kinematics, emg, ees, meta, afferents, eesIntegratedAfferents = x ##### 230216
...
#         optim_readout.zero_grad()
        ...
        ##### 230216:
        afferents = afferents.to(self.device)
            
        predicted_kinematics, predicted_neural = self.core(afferents, kinematics)
...
#         predicted_emg = readout(motor_neurons)  # [batch x dim x time]
        ...
        loss = self.criterion(predicted_kinematics, kinematics)
...
#         optim_readout.step()
    ...
    def _valid_session(self, iteration, session, is_save=False, with_pred=False):  
        ...
        batch_id = 0
        for kinematics, emg, ees, meta, afferents, eesIntegratedAfferents in valid_loader: ##### 230216
            ...
            afferents = afferents.to(self.device) ##### 230216
...
#             predicted_emg = readout(motor_neurons)  # [batch x dim x time]
            ...
            loss = self.criterion(predicted_kinematics, kinematics, reduc='none') ##### 230216
