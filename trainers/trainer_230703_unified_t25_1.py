...
#         optim_readout.step()
    ...
    def _train_iteration(self, iteration):
        ...
        for session in list_session:
            for kinematics, kinematics_2, meta in train_loader: ##### 230713!
            ...
            with torch.no_grad():
                if self.with_weight_clipping:
                    ...
                    self.core.kine2aff_connection.weight = torch.nn.parameter.Parameter(abs(self.core.kine2aff_connection.weight)) ##### v1; 230630                   
                ...
                if self.with_bias_clipping: ##### 230531
                    ...
                    self.core.kine2aff_connection.bias = torch.nn.parameter.Parameter(abs(self.core.kine2aff_connection.bias)) ##### v1
    ...
    def _valid_session(self, iteration, session, is_save=False, with_pred=False):  
        ...
        batch_id = 0
        for kinematics, kinematics_2, meta in valid_loader: ##### 230713!, 230216
            from datetime import datetime
            now = datetime.now()
            current_time = now.strftime("%H:%M:%S")            
