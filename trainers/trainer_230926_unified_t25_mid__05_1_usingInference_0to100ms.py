...
#                 loss = self.criterion(predicted_kinematics[:,:,(int(t0/tbin)-2):(int(t0/tbin)+2)], kinematics_crop[:,:,int(t0/tbin):int(t0/tbin)+4]) ##### 100ms
                loss = self.criterion(predicted_kinematics[:,:,0:(int(t0/tbin)+2)], kinematics_crop[:,:,2:int(t0/tbin)+4]) ##### 0to100ms
