...
#                 loss_emg = self.criterion(predicted_emg[:,:,0:(int(t0/tbin)-2)], emg_crop[:,:,2:int(t0/tbin)])
                ...
                # For EES sling
                loss_kine = self.criterion(predicted_kinematics[:,:,int(t0/tbin):(int((tdur+t0)/2/tbin)-2)], kinematics_crop[:,:,int(t0/tbin)+2:int((tdur+t0)/2/tbin)]) ##### _025_05
                loss_emg = self.criterion(predicted_emg[:,:,int(t0/tbin):(int((tdur+t0)/2/tbin)-2)], emg_crop[:,:,int(t0/tbin)+2:int((tdur+t0)/2/tbin)])
