    ...
    def _train_iteration(self, iteration):
        ...
        for session in list_session:
            ...
            with torch.no_grad():
                ...
                self.core.IaiF2IaiEmnE_connection.weight = torch.nn.parameter.Parameter(abs(self.core.IaiF2IaiEmnE_connection.weight)) ##### Positive weight
                ...
                self.core.IaiE2IaiFmnF_connection.weight = torch.nn.parameter.Parameter(abs(self.core.IaiE2IaiFmnF_connection.weight)) ##### Positive weight
