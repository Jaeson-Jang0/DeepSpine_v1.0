# Revised from "trainer_230731_unified_t25_mid": To combine DS1 and DS2 for parallel prediction of EMG and kinematics
...
#                 
                loss_kine = self.criterion(predicted_kinematics[:,:,0:(int(t0/tbin)-2)], kinematics_crop[:,:,2:int(t0/tbin)]) ##### 230807
                loss_emg = self.criterion(predicted_emg[:,:,0:(int(t0/tbin)-2)], emg_crop[:,:,2:int(t0/tbin)]) 
