...
from data import get_loader_synthetic
import masked_loss
import trainers
...
def main(config):
    ...
    train_loaders = get_loader_synthetic(config['data_loader']['train_loader_args'])
    valid_loaders = get_loader_synthetic(config['data_loader']['valid_loader_args'])
...
#     print(criterion.__code__.co_varnames)
