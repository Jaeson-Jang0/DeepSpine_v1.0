...
class SpinalCordCircuit_230227(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230227, self).__init__()
...
#     def forward(self, x, ees, verbose=False): # 230209
    def forward(self, kinematics, ees, verbose=False):
        ##### 230209: Variable declaration - Sensory encoder
        
        afferents_ch = self.emb_kinematics2ch(kinematics)
        
#         afferents_ch_ees = torch.cat((afferents_ch[:,:,:500], ees[:,:,500:]), dim=2) ##### 230227
        afferents_ch_ees = afferents_ch ##### 230227
#         afferents_ch_ees = afferents_ch + ees               
...
#                 II_exts_t = II_exts[..., t:(t+1)] + fb_II_exts  
                ...
                Ia_flxs_t = fb_Ia_flxs
                II_flxs_t = fb_II_flxs
                Ia_exts_t = fb_Ia_exts
                II_exts_t = fb_II_exts 
