...
class SpinalCordCircuit_230703_unified_t25_5(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230703_unified_t25_5, self).__init__()
...
#                 emg = self.rdo_activation(emg)
            ...
            ##### 230209: Somatosensory feedback
            feedback = self.kine2aff_connection(kine) ##### v2
