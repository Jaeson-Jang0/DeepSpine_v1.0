# Revised from "spine_230926_unified_t25_5_mnsFB_atOnset": To save intermediate results for illustration
...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forIllu(nn.Module):
    def __init__(self,
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forIllu, self).__init__()
...
#                 kine = self.rdo_mns2kine_list[ds_idx](mns)   
        ...
        ##### forIllu
        print(kinematics.shape, kinematics_bin.shape, afferents_ch.shape, afferents_ch_ees.shape, afferents.shape)
        kinematics = kinematics.cpu().numpy()
        kinematics_bin = kinematics_bin.cpu().numpy()
        afferents_ch = afferents_ch.cpu().numpy()
        afferents_ch_ees = afferents_ch_ees.cpu().numpy()
        afferents = afferents.cpu().numpy()
        
        return emg_stack, kine_stack, [kinematics, kinematics_bin, afferents_ch, afferents_ch_ees, afferents]