...
class SpinalCordCircuit_230720_unified_t25_5_Kine(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230720_unified_t25_5_Kine, self).__init__()
...
#         t0 = 500
        ...
        for t in range(n_bin): ##### t25
            ...
            if t == 0: ##### 230718            
                ...
                Ia_exts_t = (Ia_exts)
                II_exts_t = (II_exts)
            elif t < int(t0/t_int): ##### Kine, 230718
