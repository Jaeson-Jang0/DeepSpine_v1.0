...
class SpinalCordCircuit_230313_withKineFB(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230313_withKineFB, self).__init__()
