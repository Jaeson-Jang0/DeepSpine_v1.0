# Revised from "spine_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc: To test with 300ms of EES
...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_300ms(nn.Module):
    def __init__(self,
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_300ms, self).__init__()
...
#         y_pred = kine_stack[:,0,22] - kine_stack[:,0,18]
        y_pred = kine_stack[:,:,30] - kine_stack[:,:,18] ##### 300ms; v231010   
