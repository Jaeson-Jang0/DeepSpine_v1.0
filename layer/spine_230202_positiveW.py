...
class SpinalCordCircuit_230202_positiveW(nn.Module):
    def __init__(self, 
            Ia_neurons, 
            II_neurons, 
            ex_neurons, 
            ...
            activation='relu',
            dropout=None):
        super(SpinalCordCircuit_230202_positiveW, self).__init__()
...
#          print(self.IaF2mnFIaiF_connection.weight)
        ...
        torch.nn.init.trunc_normal_(self.IaiF2IaiEmnE_connection.weight, a=0.0, b=float('inf')) ##### Positive weight
        ...
        torch.nn.init.trunc_normal_(self.IaiE2IaiFmnF_connection.weight, a=0.0, b=float('inf')) ##### Positive weight
...
#         print(self.IaF2mnFIaiF_connection.weight)
    ...
    def forward(self, afferents, verbose=False):
        ...
        for t in range(T):
            ...
            IaisF = self.Iai_flxs([IaF2IaiF, IIF2IaiF, -torch.unsqueeze(init_IaiE,2)], init_IaiF, self.Iai_connectivity) ##### Positive weight 
            IaisE = self.Iai_exts([IaE2IaiE, IIE2IaiE, -torch.unsqueeze(init_IaiF,2)], init_IaiE, self.Iai_connectivity) ##### Positive weight
            ...
            mnsF = self.mn_flxs([IaF2mnF, exF2mnF, -IaiE2mnF], init_mnF, self.mn_connectivity) ##### Positive weight
            mnsE = self.mn_exts([IaE2mnE, exE2mnE, -IaiF2mnE], init_mnE, self.mn_connectivity) ##### Positive weight
