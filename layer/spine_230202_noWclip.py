...
class SpinalCordCircuit_230202_noWclip(nn.Module):
    def __init__(self, 
            Ia_neurons, 
            II_neurons, 
            ex_neurons, 
            ...
            activation='relu',
            dropout=None):
        super(SpinalCordCircuit_230202_noWclip, self).__init__()
...
#          print(self.IaF2mnFIaiF_connection.weight)
        ...
        ##### noWclip
        torch.nn.init.normal_(self.IaF2mnFIaiF_connection.weight)
        torch.nn.init.normal_(self.IIF2exFIaiF_connection.weight)
        torch.nn.init.normal_(self.exF2mnF_connection.weight)
        torch.nn.init.normal_(self.IaiF2IaiEmnE_connection.weight)
        
        torch.nn.init.normal_(self.IaE2mnEIaiE_connection.weight)
        torch.nn.init.normal_(self.IIE2exEIaiE_connection.weight)
        torch.nn.init.normal_(self.exE2mnE_connection.weight)
        torch.nn.init.normal_(self.IaiE2IaiFmnF_connection.weight)
