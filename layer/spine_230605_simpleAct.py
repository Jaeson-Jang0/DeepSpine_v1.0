...
#         print("Input: ", xx.shape, xs.shape, in_layer_pre.shape)
        print('In_layer: ', in_layer_pre.shape)
        if EI is not None:                
            # EI: [P]
...
#             in_layer = self.activation(in_layer[:,EI].sum(1) - in_layer[:,~EI].sum(1)) # [BxN]
        ...
        print('In_layer: ', in_layer.shape)

        h = self.int_layer(in_layer, hx)
 
        hiddens.append(h)

#         print("Shape: ", in_layer.shape, h.shape, hx.shape, torch.stack(hiddens[1:], dim=2).shape, xx.shape, g.shape, g_pre.shape, in_layer_pre.shape)
    
        return torch.stack(hiddens[1:], dim=2), in_layer.unsqueeze(2), hx.unsqueeze(2), xx, g, g_pre, in_layer_pre  ##### 230531 # exclude initial hidden state


class SpinalCordCircuit_230605_simpleAct(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230605_simpleAct, self).__init__()
...
#             II_exts_t = torch.mean(II_exts_t, dim=2, keepdim=True)
            ...
            if t == 0:
                ...
                IaisF_inlayer_stack = IaisF_inlayer
                IaisF_hx_stack = IaisF_hx
                IaisE_inlayer_stack = IaisE_inlayer
                IaisE_hx_stack = IaisE_hx
...
#                 return emg_stack, [afferents_ch, afferents_ch_ees, afferents, exsF_stack, IaisF_stack, mnsF_stack, exsE_stack, IaisE_stack, mnsE_stack, Ia_flxs_t_stack, II_flxs_t_stack, Ia_exts_t_stack, II_exts_t_stack, IaF2mnF_stack, IaF2IaiF_stack, IIF2exF_stack, IIF2IaiF_stack, IaE2mnE_stack, IaE2IaiE_stack, IIE2exE_stack, IIE2IaiE_stack, exF2mnF_stack, IaiE2mnF_stack, exE2mnE_stack, IaiF2mnE_stack, Ia_flxs_stack, II_flxs_stack, Ia_exts_stack, II_exts_stack, fb_Ia_flxs_stack, fb_II_flxs_stack, fb_Ia_exts_stack, fb_II_exts_stack, mnsF_inlayer_stack, mnsF_hx_stack, mnsE_inlayer_stack, mnsE_hx_stack, mnsF_x_stack, mnsF_g_stack, mnsF_gpre_stack, mnsF_inlayerpre_stack, mnsE_x_stack, mnsE_g_stack, mnsE_gpre_stack, mnsE_inlayerpre_stack] ##### 230605
                return emg_stack, [afferents_ch, afferents_ch_ees, afferents, exsF_stack, IaisF_stack, mnsF_stack, exsE_stack, IaisE_stack, mnsE_stack, Ia_flxs_t_stack, II_flxs_t_stack, Ia_exts_t_stack, II_exts_t_stack, IaF2mnF_stack, IaF2IaiF_stack, IIF2exF_stack, IIF2IaiF_stack, IaE2mnE_stack, IaE2IaiE_stack, IIE2exE_stack, IIE2IaiE_stack, exF2mnF_stack, IaiE2mnF_stack, exE2mnE_stack, IaiF2mnE_stack, Ia_flxs_stack, II_flxs_stack, Ia_exts_stack, II_exts_stack, fb_Ia_flxs_stack, fb_II_flxs_stack, fb_Ia_exts_stack, fb_II_exts_stack, mnsF_inlayer_stack, mnsF_hx_stack, mnsE_inlayer_stack, mnsE_hx_stack, mnsF_x_stack, mnsF_g_stack, mnsF_gpre_stack, mnsF_inlayerpre_stack, mnsE_x_stack, mnsE_g_stack, mnsE_gpre_stack, mnsE_inlayerpre_stack,
                                   ...
                                   IaisF_inlayer_stack, IaisF_hx_stack, IaisE_inlayer_stack, IaisE_hx_stack, IaisF_x_stack, IaisF_g_stack, IaisF_gpre_stack, IaisF_inlayerpre_stack, IaisE_x_stack, IaisE_g_stack, IaisE_gpre_stack, IaisE_inlayerpre_stack] ##### 230605