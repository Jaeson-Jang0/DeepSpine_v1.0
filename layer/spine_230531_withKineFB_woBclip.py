...
#         print(xs.shape, hx.shape, xx.shape, g.shape, in_layer.shape)
...
class SpinalCordCircuit_230531_withKineFB_woBclip(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230531_withKineFB_woBclip, self).__init__()
...
#             print("MNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNn")
...
#             print(exsF.shape, Ia_flxs_t.shape, IaF2mnF.shape) 
            ...
            if t == 0:
                ...
                exF2mnF_stack = torch.cat((exF2mnF_stack, exF2mnF), 2) #= exF2mnF
                IaiE2mnF_stack = torch.cat((IaiE2mnF_stack, IaiE2mnF), 2) #= IaiE2mnF
                exE2mnE_stack = torch.cat((exE2mnE_stack, exE2mnE), 2) #= exE2mnE
                IaiF2mnE_stack = torch.cat((IaiF2mnE_stack, IaiF2mnE), 2) #= IaiF2mnE 
