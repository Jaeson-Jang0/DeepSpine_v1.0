...
class SpinalCordCircuit_230627_unified(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230627_unified, self).__init__()
...
#             print('T = ', t)
            ...
            ##### 230309
            if t > 0:                
                afferents_ch_emg = self.emb_kinematics2ch(emg)
                              
                if with_ees:
                    afferents_ch_ees_emg = afferents_ch_emg + ees[:,:,t:t+1]
                    afferents_emg = self.emb_ch2afferent(afferents_ch_ees_emg)               
                else:
                    afferents_emg = self.emb_ch2afferent(afferents_ch_emg)               
            ...
            ##### Time series
            # fb_Ia_flxs: FB from kinematics, Ia_flxs_emg: Neural afferents from predicted kinematics
            if t == 0:            
                ...
                coef = t/int(t0/2)
                Ia_flxs_t = (1-coef)*Ia_flxs + coef*Ia_flxs_emg + fb_Ia_flxs # withKineFB
                II_flxs_t = (1-coef)*II_flxs + coef*II_flxs_emg + fb_II_flxs
                Ia_exts_t = (1-coef)*Ia_exts + coef*Ia_exts_emg + fb_Ia_exts
                II_exts_t = (1-coef)*II_exts + coef*II_exts_emg + fb_II_exts
            else:
...
#                 emg = self.rdo_activation(emg)
        ...
        if verbose:
            ...
            if self.offset > 0:
                ...
                return emg_stack, [afferents_ch, afferents_ch_ees, afferents, exsF_stack, IaisF_stack, mnsF_stack, exsE_stack, IaisE_stack, mnsE_stack, Ia_flxs_t_stack, II_flxs_t_stack, Ia_exts_t_stack, II_exts_t_stack,
