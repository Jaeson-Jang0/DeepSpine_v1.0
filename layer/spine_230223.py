...
class SpinalCordCircuit_230223(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230223, self).__init__()
...
#         print("Check again: ", afferents_ori.shape)
#         afferents = self.emb_kinematic2afferent(afferents_ori) # BxCxT
#         afferents = self.emb_kinematic2afferent(kinematics) # BxCxT
