...
class SpinalCordCircuit_230202_weightShare(nn.Module):
    def __init__(self, 
            Ia_neurons, 
            II_neurons, 
            ex_neurons, 
            ...
            activation='relu',
            dropout=None):
        super(SpinalCordCircuit_230202_weightShare, self).__init__()
...
#         print(self.IaF2mnFIaiF_connection.weight)
    ...
    def forward(self, afferents, verbose=False):
        ...
        for t in range(T):
            ...
            IaE2mnEIaiE = self.IaF2mnFIaiF_connection(Ia_exts[..., t:(t+1)]) ##### Weight sharing
            IIE2exEIaiE = self.IIF2exFIaiF_connection(II_exts[..., t:(t+1)]) ##### Weight sharing
            ...
            exE2mnE = self.exF2mnF_connection(exsE) ##### Weight sharing
            ...
            IaiE2IaiFmnF = self.IaiF2IaiEmnE_connection(IaisE) ##### Weight sharing
