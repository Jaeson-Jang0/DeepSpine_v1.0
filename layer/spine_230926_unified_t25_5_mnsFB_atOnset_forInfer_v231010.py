...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010(nn.Module):
    def __init__(self,
            ...
            mn_neurons,
            Tmax,
            rdo_in_channels, rdo_emg_channels, rdo_out_channels, rdo_kernel_size, ini_kine, ##### forInfer
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010, self).__init__()
...
#         t_total, t0 = 1000, 500
        ...
        ##### v231010, forInfer
        import json
#         file_path = '/home/jjang50/Codes/Test_retest_HD64/virtual_inputs_v1_231010.json'
        file_path = '/home/jjang50/Codes/Test_retest_HD64/virtual_inputs_v1_231010_inc.json'
        with open(file_path, 'r') as json_file:
            virtual_kine = json.load(json_file)
            
#         ini_kine_array = torch.unsqueeze(torch.unsqueeze(torch.tensor(self.ini_kine,dtype=torch.double),0),2).repeat((1,1,t_total)).to(torch.float32) ##### forInfer                
#         kinematics = torch.zeros((1,2,t_total)) + ini_kine_array
...
#         y_pred = kine_stack[:,0,22] - kine_stack[:,0,18]
        ...
        y_base = kine_crop[:,:,24] - kine_stack[:,:,20]
