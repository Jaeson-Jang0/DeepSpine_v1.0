...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_xy(nn.Module):
    def __init__(self,
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_xy, self).__init__()
...
#         t_total, t0 = 1000, 500
        ...
        if torch.sum(theta) != 0:
            ...
            if len(theta.shape)==2:
                ...
                elec_x_idx = torch.argmax(theta[0,2:10]) ##### xy
                elec_y_idx = torch.argmax(theta[0,10:])
...
#             ees[:, elec_idx, :] = ees_template
            ees[:, elec_x_idx, :] = ees_template ##### xy
            ees[:, elec_y_idx+8, :] = ees_template
