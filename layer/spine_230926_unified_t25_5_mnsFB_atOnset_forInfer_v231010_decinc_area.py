# Revised from "spine_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc": To change the error term into area (last line)
...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_area(nn.Module):
    def __init__(self,
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer_v231010_decinc_area, self).__init__()
...
#         y_base = kine_crop[:,:,24] - kine_stack[:,:,20] ##### This had to be crop!!!!!!!!!!!!!1
#         y_cal = y_pred - y_base       
        
        y_cal = torch.sum(kine_stack[:,:,18:23] - kine_crop[:,:,20:25], dim=2) ##### area
#         print(kine_stack[:,:,18:23])
#         print(kine_crop[:,:,20:25])
#         print(kine_stack[:,:,18:23] - kine_crop[:,:,20:25])
#         print(torch.sum(kine_stack[:,:,18:23] - kine_crop[:,:,20:25], dim=2))
#         print(torch.sum(kine_stack[:,:,18:23] - kine_crop[:,:,20:25], dim=2).shape)
