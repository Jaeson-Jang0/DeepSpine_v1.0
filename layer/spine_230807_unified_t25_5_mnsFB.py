# Revised from "spine_230802_unified_t25_5_mnsFB": To combine DS1 and DS2 for parallel prediction of EMG and kinematics
# Revised form "spine_230727_unified_t25_5_mnsFB": Not mns->EMG->Kine, but mns->EMG and mns->Kine
...
class SpinalCordCircuit_230807_unified_t25_5_mnsFB(nn.Module):
    def __init__(self,
            emb_in_channels, emb_out_channels, emb_kernel_size,
            emb2_in_channels, emb2_out_channels,
            Ia_neurons, II_neurons, ex_neurons, Iai_neurons, mn_neurons,
            Tmax, rdo_in_channels, rdo_emg_channels, rdo_out_channels, rdo_kernel_size,
                 
            emb_in_channels_2, ##### 230807
            emb_out_channels_2, emb_kernel_size_2, emb2_in_channels_2, emb2_out_channels_2,
            Ia_neurons_2, II_neurons_2, ex_neurons_2, Iai_neurons_2, mn_neurons_2,
            Tmax_2, rdo_in_channels_2, rdo_emg_channels_2, rdo_out_channels_2, rdo_kernel_size_2,
                 
            rdo_groups=1, rdo_activation='none',
            offset=0, activation='relu', dropout=None, rdo_use_norm=None,
            emb_groups=1, emb_activation='relu', emb_use_norm=None,
                 
            rdo_groups_2=1, rdo_activation_2='none',
            offset_2=0, activation_2='relu', dropout_2=None, rdo_use_norm_2=None,
            emb_groups_2=1, emb_activation_2='relu', emb_use_norm_2=None
                ):
        super(SpinalCordCircuit_230807_unified_t25_5_mnsFB, self).__init__()
...
#         self.rdo_emg2kine = CausalConv1d(rdo_emg_channels, rdo_out_channels, kernel_size=rdo_kernel_size, groups=rdo_groups, pad=rdo_kernel_size-1)
        self.rdo_mns2kine = CausalConv1d(rdo_in_channels + rdo_in_channels_2, rdo_out_channels, kernel_size=rdo_kernel_size, groups=rdo_groups, pad=rdo_kernel_size-1) ##### 230807
...
#             self.rdo_norm = LayerNorm(dim=2, affine_shape=[rdo_groups, int(rdo_out_channels/rdo_groups), 1])
        ...
        self.mns2aff_connection = conv1d(2*mn_neurons, 2*(Ia_neurons+II_neurons), kernel_size=1, groups=1) ##### v1; 230630
#         torch.nn.init.trunc_normal_(self.mns2aff_connection.weight, a=0.0, b=float('inf')) ##### 230727; v1; 230531

        ##### 230531: Bias clipping
        torch.nn.init.trunc_normal_(self.IaF2mnFIaiF_connection.bias, a=0.0, b=0.0)
        torch.nn.init.trunc_normal_(self.IIF2exFIaiF_connection.bias, a=0.0, b=0.0)
...
#         torch.nn.init.trunc_normal_(self.IaiF2IaiEmnE_connection.bias, a=-float('inf'), b=0)
        ...
        torch.nn.init.trunc_normal_(self.IaE2mnEIaiE_connection.bias, a=0.0, b=0.0)
        torch.nn.init.trunc_normal_(self.IIE2exEIaiE_connection.bias, a=0.0, b=0.0)
...
#         torch.nn.init.trunc_normal_(self.mns2aff_connection.bias, a=0.0, b=float('inf')) ##### v1; 230531

        ##### 230807 #############################################################3
        ##### 230209: Sensory encoder
        if emb_activation_2 == 'relu':
            self.emb_activation_2 = nn.ReLU(inplace=True)
        elif emb_activation_2 == 'tanh':
            self.emb_activation_2 = nn.Tanh()
        elif emb_activation_2 == 'sigmoid':
            self.emb_activation_2 = nn.Sigmoid()
        else:
            self.emb_activation_2 = None
        
        self.emb_use_norm_2 = emb_use_norm_2
        self.emb_groups_2 = emb_groups_2

        self.emb_kinematics2ch_2 = ConvNet1d(emb_in_channels_2, emb_out_channels_2, emb_kernel_size_2, emb_groups_2, emb_use_norm_2, emb_activation_2)
        self.emb_ch2afferent_2 = ConvNet1d(emb2_in_channels_2, emb2_out_channels_2, emb_kernel_size_2, emb_groups_2, emb_use_norm_2, emb_activation_2)
        self.emb_spike2rate_2 = CausalConv1d(1, 1, kernel_size=30, groups=1, pad=29)
        self.emb_antidromic_2 = CausalConv1d(1, 1, kernel_size=20, groups=1, pad=19)   
        self.emb_affine_2 = Affine(emb_out_channels_2, init_gamma=0.1, init_beta=-26) 

        ##### Core
        self.Ia_neurons_2 = Ia_neurons_2
        self.II_neurons_2 = II_neurons_2
        self.ex_neurons_2 = ex_neurons_2
        self.Iai_neurons_2 = Iai_neurons_2
        self.mn_neurons_2 = mn_neurons_2

        self.offset_2 = offset_2
        conv1d_2 = nn.Conv1d

        # v230119
        self.ex_flxs_2 = Layer(
            in_pathways=1, 
            out_neurons=ex_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2
        )
        self.Iai_flxs_pre_2= Layer(
            in_pathways=2, 
            out_neurons=Iai_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2,
            reciprocal_inhibition=True
        )
        self.Iai_flxs_2 = Layer(
            in_pathways=3, 
            out_neurons=Iai_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2,
        ...
        self.mn_flxs_2 = Layer(
            in_pathways=3, 
            out_neurons=mn_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2
        )        
        self.ex_exts_2 = Layer(
            in_pathways=1, 
            out_neurons=ex_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2
        )
        self.Iai_exts_pre_2 = Layer(
            in_pathways=2, 
            out_neurons=Iai_neurons_2, 
            Tmax=Tmax_2,
            activation=activation_2,
        ...
        self.IaF2mnFIaiF_connection_2 = conv1d(Ia_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)                
        self.IIF2exFIaiF_connection_2 = conv1d(II_neurons_2, (Iai_neurons_2 + ex_neurons_2), kernel_size=1, groups=1)        
        self.exF2mnF_connection_2 = conv1d(ex_neurons_2, mn_neurons_2, kernel_size=1, groups=1)
        self.IaiF2IaiEmnE_connection_2 = conv1d(Iai_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)
        
        self.IaE2mnEIaiE_connection_2 = conv1d(Ia_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)                
        self.IIE2exEIaiE_connection_2 = conv1d(II_neurons_2, (Iai_neurons_2 + ex_neurons_2), kernel_size=1, groups=1)        
        self.exE2mnE_connection_2 = conv1d(ex_neurons_2, mn_neurons_2, kernel_size=1, groups=1)
        self.IaiE2IaiFmnF_connection_2 = conv1d(Iai_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)
        
        torch.nn.init.trunc_normal_(self.IaF2mnFIaiF_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.IIF2exFIaiF_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.exF2mnF_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.IaiF2IaiEmnE_connection_2.weight, a=-float('inf'), b=0)
        
        torch.nn.init.trunc_normal_(self.IaE2mnEIaiE_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.IIE2exEIaiE_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.exE2mnE_connection_2.weight, a=0.0, b=float('inf'))
        torch.nn.init.trunc_normal_(self.IaiE2IaiFmnF_connection_2.weight, a=-float('inf'), b=0)
        
        ##### Saving initial weight matrices
        self.IaF2mnFIaiF_connection_ini_2 = conv1d(Ia_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)        
        self.IIF2exFIaiF_connection_ini_2 = conv1d(II_neurons_2, (Iai_neurons_2 + ex_neurons_2), kernel_size=1, groups=1)        
        self.exF2mnF_connection_ini_2 = conv1d(ex_neurons_2, mn_neurons_2, kernel_size=1, groups=1)
        self.IaiF2IaiEmnE_connection_ini_2 = conv1d(Iai_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)
        
        self.IaE2mnEIaiE_connection_ini_2 = conv1d(Ia_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)          
        self.IIE2exEIaiE_connection_ini_2 = conv1d(II_neurons_2, (Iai_neurons_2 + ex_neurons_2), kernel_size=1, groups=1)        
        self.exE2mnE_connection_ini_2 = conv1d(ex_neurons_2, mn_neurons_2, kernel_size=1, groups=1)
        self.IaiE2IaiFmnF_connection_ini_2 = conv1d(Iai_neurons_2, (Iai_neurons_2 + mn_neurons_2), kernel_size=1, groups=1)

        self.IaF2mnFIaiF_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IaF2mnFIaiF_connection_2.weight)
        self.IIF2exFIaiF_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IIF2exFIaiF_connection_2.weight)
        self.exF2mnF_connection_ini_2.weight = torch.nn.parameter.Parameter(self.exF2mnF_connection_2.weight)
        self.IaiF2IaiEmnE_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IaiF2IaiEmnE_connection_2.weight)

        self.IaE2mnEIaiE_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IaE2mnEIaiE_connection_2.weight)
        self.IIE2exEIaiE_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IIE2exEIaiE_connection_2.weight)
        self.exE2mnE_connection_ini_2.weight = torch.nn.parameter.Parameter(self.exE2mnE_connection_2.weight)
        self.IaiE2IaiFmnF_connection_ini_2.weight = torch.nn.parameter.Parameter(self.IaiE2IaiFmnF_connection_2.weight)

        # excitatory pathways (True): Ia2mn, ex2mn || inhibitory pathways (False): Iai2mn
        self.register_buffer('ex_connectivity_2', torch.BoolTensor([True])) 
        self.register_buffer('Iai_connectivity_2', torch.BoolTensor([True, True, False])) 
        self.register_buffer('mn_connectivity_2', torch.BoolTensor([True, True, True])) ##### 230531: Already negative
#         self.register_buffer('mn_connectivity', torch.BoolTensor([True, True, False])) ##### 230531: Already negative
        ...
        ##### 230209: Readout
        if rdo_activation_2 == 'relu':
            rdo_activation_2 = nn.ReLU(inplace=True)
        elif rdo_activation_2 == 'tanh':
            rdo_activation_2 = nn.Tanh()
        elif rdo_activation_2 == 'sigmoid':
            rdo_activation_2 = nn.Sigmoid()
        else:
            rdo_activation_2 = None
        
        self.rdo_activation_2 = rdo_activation_2
        self.rdo_groups_2 = rdo_groups_2
       
        self.rdo_mns2emg_2 = CausalConv1d(rdo_in_channels_2, rdo_emg_channels_2, kernel_size=rdo_kernel_size_2, groups=rdo_groups_2, pad=rdo_kernel_size_2-1)
#         self.rdo_mns2kine_2 = CausalConv1d(rdo_in_channels_2, rdo_out_channels_2, kernel_size=rdo_kernel_size_2, groups=rdo_groups_2, pad=rdo_kernel_size_2-1)

        ##### 230209: Somatosensory feedback        
        self.mns2aff_connection_2 = conv1d(2*mn_neurons_2, 2*(Ia_neurons_2+II_neurons_2), kernel_size=1, groups=1) ##### v1; 230630
#         torch.nn.init.trunc_normal_(self.mns2aff_connection.weight_2, a=0.0, b=float('inf')) ##### 230727; v1; 230531

        ##### 230531: Bias clipping
        torch.nn.init.trunc_normal_(self.IaF2mnFIaiF_connection_2.bias, a=0.0, b=0.0)
        torch.nn.init.trunc_normal_(self.IIF2exFIaiF_connection_2.bias, a=0.0, b=0.0)
        
        torch.nn.init.trunc_normal_(self.IaE2mnEIaiE_connection_2.bias, a=0.0, b=0.0)
        torch.nn.init.trunc_normal_(self.IIE2exEIaiE_connection_2.bias, a=0.0, b=0.0)
    ...
    def forward(self, kinematics, ees, with_ees, with_layernorm): ##### 230703 ##### 230307
...
#         t0 = 500
        ...
        init_ex_2, init_Iai_2, init_mn_2 = self._init_hidden(kinematics) ##### 230807
        init_exF_2, init_exE_2 = init_ex_2, init_ex_2
        init_IaiF_2, init_IaiE_2 = init_Iai_2, init_Iai_2
        init_mnF_2, init_mnE_2 = init_mn_2, init_mn_2
        
        if self.dropout is not None:
            afferents = self.dropout(afferents)
            
        if self.dropout_2 is not None:
            afferents_2 = self.dropout(afferents_2)
        ...
        for t in range(n_bin): ##### t25
            ...
            if t == 0: ##### mnsFB, 230718            
                ...
                Ia_exts_t = (Ia_exts)
                II_exts_t = (II_exts)
            else: #elif t < int(t0/t_int): ##### 230718
...
#             elif t == int(t0/t_int): ##### 230718
#                 Ia_flxs_t = torch.cat((Ia_flxs[:, :, :t_int], Ia_flxs_kine[:,:,t_int:]), dim=2) #+ fb_Ia_flxs ##### 230718
#                 II_flxs_t = torch.cat((II_flxs[:, :, :t_int], II_flxs_kine[:,:,t_int:]), dim=2) #+ fb_II_flxs
#                 Ia_exts_t = torch.cat((Ia_exts[:, :, :t_int], Ia_exts_kine[:,:,t_int:]), dim=2) #+ fb_Ia_exts
#                 II_exts_t = torch.cat((II_exts[:, :, :t_int], II_exts_kine[:,:,t_int:]), dim=2) #+ fb_II_exts                 
# #                 coef = t/int(t0/2)
...
#                 II_exts_t = II_exts_kine #+ fb_II_exts           
            ...
            exsF, exsF_inlayer, exsF_hx, exsF_x, exsF_g, exsF_gpre, exsF_inlayerpre = self.ex_flxs([IIF2exF], init_exF, self.ex_connectivity, with_layernorm) ##### 230531
            exF2mnF = self.exF2mnF_connection(exsF)

            exsE, exsE_inlayer, exsE_hx, exsE_x, exsE_g, exsE_gpre, exsE_inlayerpre = self.ex_exts([IIE2exE], init_exE, self.ex_connectivity, with_layernorm)
            exE2mnE = self.exE2mnE_connection(exsE)       

            ##### Inhibitory neuron activity
            IaisF, IaisF_inlayer, IaisF_hx, IaisF_x, IaisF_g, IaisF_gpre, IaisF_inlayerpre = self.Iai_flxs([IaF2IaiF, IIF2IaiF, torch.unsqueeze(init_IaiE,2)], init_IaiF, self.Iai_connectivity, with_layernorm) ##### 230531
            IaisE, IaisE_inlayer, IaisE_hx, IaisE_x, IaisE_g, IaisE_gpre, IaisE_inlayerpre = self.Iai_exts([IaE2IaiE, IIE2IaiE, torch.unsqueeze(init_IaiF,2)], init_IaiE, self.Iai_connectivity, with_layernorm)   
            ...
            mnsF, mnsF_inlayer, mnsF_hx, mnsF_x, mnsF_g, mnsF_gpre, mnsF_inlayerpre = self.mn_flxs([IaF2mnF, exF2mnF, IaiE2mnF], init_mnF, self.mn_connectivity, with_layernorm)
            mnsE, mnsE_inlayer, mnsE_hx, mnsE_x, mnsE_g, mnsE_gpre, mnsE_inlayerpre = self.mn_exts([IaE2mnE, exE2mnE, IaiF2mnE], init_mnE, self.mn_connectivity, with_layernorm)
...
#                 emg = self.rdo_activation(emg)
            ...
            ##### 230209: Somatosensory feedback
            feedback = self.mns2aff_connection(mns) ##### v2
            ...
            ##### 230807 ###################################################################
            afferents_ch_2 = self.emb_kinematics2ch_2(kinematics_bin)
            
            if with_ees:
                afferents_ch_ees_2 = afferents_ch_2 + ees[:,:,t_start:t_start+t_bin]
            else:
                afferents_ch_ees_2 = afferents_ch_2 ##### 230713
            
            afferents_2 = self.emb_ch2afferent_2(afferents_ch_ees_2)               
              
            # Ia: [BxIaNxT], II: [BxIINxT] (IaN: # of Ia neurons, IIN: # of II neurons)
            Ia_2, II_2 = torch.split(afferents_2, [2*self.Ia_neurons_2, 2*self.II_neurons_2], dim=1)              
            Ia_flxs_2, Ia_exts_2 = torch.split(Ia_2, [self.Ia_neurons_2, self.Ia_neurons_2], dim=1)
            II_flxs_2, II_exts_2 = torch.split(II_2, [self.II_neurons_2, self.II_neurons_2], dim=1) 

            batch_size, T = Ia_flxs_2.shape[0], Ia_flxs_2.shape[-1]  
            
            ##### 230309
            if t > int(t0/t_int) - 3: #17: ##### 230718, t25
                kinematics_bin_fb_2 = torch.cat((torch.tile(kine_1, (1,1,t_int)), torch.tile(kine, (1,1,t_int))), dim=2) ##### 230718
                afferents_ch_kine_2 = self.emb_kinematics2ch_2(kinematics_bin_fb_2) ##### t25
                                              
                if with_ees:
                    afferents_ch_ees_kine_2 = afferents_ch_kine_2 + ees[:,:,t_start:t_start+t_bin]
                    afferents_kine_2 = self.emb_ch2afferent_2(afferents_ch_ees_kine_2) ##### t25
                else:
                    afferents_kine_2 = self.emb_ch2afferent_2(afferents_ch_kine_2)               

                # Ia: [BxIaNxT], II: [BxIINxT] (IaN: # of Ia neurons, IIN: # of II neurons)
                Ia_kine_2, II_kine_2 = torch.split(afferents_kine_2, [2*self.Ia_neurons_2, 2*self.II_neurons_2], dim=1)              
                Ia_flxs_kine_2, Ia_exts_kine_2 = torch.split(Ia_kine_2, [self.Ia_neurons_2, self.Ia_neurons_2], dim=1)
                II_flxs_kine_2, II_exts_kine_2 = torch.split(II_kine_2, [self.II_neurons_2, self.II_neurons_2], dim=1) 
        
            ##### Time series
            # fb_Ia_flxs: FB from motor neurons, Ia_flxs_kine: Neural afferents from predicted kinematics
            if t == 0: ##### mnsFB, 230718            
                Ia_flxs_t_2 = (Ia_flxs_2) # copy.deepcopy
                II_flxs_t_2 = (II_flxs_2)
                Ia_exts_t_2 = (Ia_exts_2)
                II_exts_t_2 = (II_exts_2)
            else: #elif t < int(t0/t_int): ##### 230718
                Ia_flxs_t_2 = Ia_flxs_2 + fb_Ia_flxs_2 ##### v5 # withKineFB
                II_flxs_t_2 = II_flxs_2 + fb_II_flxs_2
                Ia_exts_t_2 = Ia_exts_2 + fb_Ia_exts_2
                II_exts_t_2 = II_exts_2 + fb_II_exts_2
        
            ##### Ia & II neural afferents to neurons
            IaF2mnFIaiF_2 = self.IaF2mnFIaiF_connection_2(Ia_flxs_t_2)
            IIF2exFIaiF_2 = self.IIF2exFIaiF_connection_2(II_flxs_t_2)
            IaE2mnEIaiE_2 = self.IaE2mnEIaiE_connection_2(Ia_exts_t_2)
            IIE2exEIaiE_2 = self.IIE2exEIaiE_connection_2(II_exts_t_2)            
                       
            IaF2mnF_2, IaF2IaiF_2 = IaF2mnFIaiF_2.split([self.mn_neurons_2, self.Iai_neurons_2], dim=1)
            IIF2exF_2, IIF2IaiF_2 = IIF2exFIaiF_2.split([self.ex_neurons_2, self.Iai_neurons_2], dim=1)
            IaE2mnE_2, IaE2IaiE_2 = IaE2mnEIaiE_2.split([self.mn_neurons_2, self.Iai_neurons_2], dim=1)
            IIE2exE_2, IIE2IaiE_2 = IIE2exEIaiE_2.split([self.ex_neurons_2, self.Iai_neurons_2], dim=1)
            
            IaF2mnF_2 = torch.mean(IaF2mnF_2, dim=2, keepdim=True) ##### t25; 230307
            IaF2IaiF_2 = torch.mean(IaF2IaiF_2, dim=2, keepdim=True)
            IIF2exF_2 = torch.mean(IIF2exF_2, dim=2, keepdim=True)
            IIF2IaiF_2 = torch.mean(IIF2IaiF_2, dim=2, keepdim=True)
            IaE2mnE_2 = torch.mean(IaE2mnE_2, dim=2, keepdim=True)
            IaE2IaiE_2 = torch.mean(IaE2IaiE_2, dim=2, keepdim=True)
            IIE2exE_2 = torch.mean(IIE2exE_2, dim=2, keepdim=True)
            IIE2IaiE_2 = torch.mean(IIE2IaiE_2, dim=2, keepdim=True)
            
            ##### Excitatory neuron activity
            exsF_2, exsF_inlayer_2, exsF_hx_2, exsF_x_2, exsF_g_2, exsF_gpre_2, exsF_inlayerpre_2 = self.ex_flxs_2([IIF2exF_2], init_exF_2, self.ex_connectivity_2, with_layernorm) ##### 230531
            exF2mnF_2 = self.exF2mnF_connection_2(exsF_2)

            exsE_2, exsE_inlayer_2, exsE_hx_2, exsE_x_2, exsE_g_2, exsE_gpre_2, exsE_inlayerpre_2 = self.ex_exts_2([IIE2exE_2], init_exE_2, self.ex_connectivity_2, with_layernorm)
            exE2mnE_2 = self.exE2mnE_connection_2(exsE_2)       

            ##### Inhibitory neuron activity
            IaisF_2, IaisF_inlayer_2, IaisF_hx_2, IaisF_x_2, IaisF_g_2, IaisF_gpre_2, IaisF_inlayerpre_2 = self.Iai_flxs_2([IaF2IaiF_2, IIF2IaiF_2, torch.unsqueeze(init_IaiE_2,2)], init_IaiF_2, self.Iai_connectivity_2, with_layernorm) ##### 230531
            IaisE_2, IaisE_inlayer_2, IaisE_hx_2, IaisE_x_2, IaisE_g_2, IaisE_gpre_2, IaisE_inlayerpre_2 = self.Iai_exts_2([IaE2IaiE_2, IIE2IaiE_2, torch.unsqueeze(init_IaiF_2,2)], init_IaiE_2, self.Iai_connectivity_2, with_layernorm)   

            IaiF2IaiEmnE_2 = self.IaiF2IaiEmnE_connection_2(IaisF_2)
            IaiF2IaiE_2, IaiF2mnE_2 = IaiF2IaiEmnE_2.split([self.Iai_neurons_2, self.mn_neurons_2], dim=1)

            IaiE2IaiFmnF_2 = self.IaiE2IaiFmnF_connection_2(IaisE_2)
            IaiE2IaiF_2, IaiE2mnF_2 = IaiE2IaiFmnF_2.split([self.Iai_neurons_2, self.mn_neurons_2], dim=1)
            
            ##### Motor neuron activity
            mnsF_2, mnsF_inlayer_2, mnsF_hx_2, mnsF_x_2, mnsF_g_2, mnsF_gpre_2, mnsF_inlayerpre_2 = self.mn_flxs_2([IaF2mnF_2, exF2mnF_2, IaiE2mnF_2], init_mnF_2, self.mn_connectivity_2, with_layernorm)
            mnsE_2, mnsE_inlayer_2, mnsE_hx_2, mnsE_x_2, mnsE_g_2, mnsE_gpre_2, mnsE_inlayerpre_2 = self.mn_exts_2([IaE2mnE_2, exE2mnE_2, IaiF2mnE_2], init_mnE_2, self.mn_connectivity_2, with_layernorm)
                        
            ##### 230605
            mnsF_hx_2 = mnsF_hx_2.unsqueeze(2)
            mnsF_inlayer_2 = mnsF_inlayer_2.unsqueeze(2)
            mnsE_hx_2 = mnsE_hx_2.unsqueeze(2)
            mnsE_inlayer_2 = mnsE_inlayer_2.unsqueeze(2)
            
            exsF_hx_2 = exsF_hx_2.unsqueeze(2)
            exsF_inlayer_2 = exsF_inlayer_2.unsqueeze(2)
            exsE_hx_2 = exsE_hx_2.unsqueeze(2)
            exsE_inlayer_2 = exsE_inlayer_2.unsqueeze(2)
            
            IaisF_hx_2 = IaisF_hx_2.unsqueeze(2)
            IaisF_inlayer_2 = IaisF_inlayer_2.unsqueeze(2)
            IaisE_hx_2 = IaisE_hx_2.unsqueeze(2)
            IaisE_inlayer_2 = IaisE_inlayer_2.unsqueeze(2)
            
            mnsF_x_2 = mnsF_x_2.unsqueeze(3)
            mnsF_g_2 = mnsF_g_2.unsqueeze(3)
            mnsF_gpre_2 = mnsF_gpre_2.unsqueeze(3)
            mnsF_inlayerpre_2 = mnsF_inlayerpre_2.unsqueeze(3)
            mnsE_x_2 = mnsE_x_2.unsqueeze(3)
            mnsE_g_2 = mnsE_g_2.unsqueeze(3)
            mnsE_gpre_2 = mnsE_gpre_2.unsqueeze(3)
            mnsE_inlayerpre_2 = mnsE_inlayerpre_2.unsqueeze(3)
            
            exsF_x_2 = exsF_x_2.unsqueeze(3)
            exsF_g_2 = exsF_g_2.unsqueeze(3)
            exsF_gpre_2 = exsF_gpre_2.unsqueeze(3)
            exsF_inlayerpre_2 = exsF_inlayerpre_2.unsqueeze(3)
            exsE_x_2 = exsE_x_2.unsqueeze(3)
            exsE_g_2 = exsE_g_2.unsqueeze(3)
            exsE_gpre_2 = exsE_gpre_2.unsqueeze(3)
            exsE_inlayerpre_2 = exsE_inlayerpre_2.unsqueeze(3)
            
            IaisF_x_2 = IaisF_x_2.unsqueeze(3)
            IaisF_g_2 = IaisF_g_2.unsqueeze(3)
            IaisF_gpre_2 = IaisF_gpre_2.unsqueeze(3)
            IaisF_inlayerpre_2 = IaisF_inlayerpre_2.unsqueeze(3)
            IaisE_x_2 = IaisE_x_2.unsqueeze(3)
            IaisE_g_2 = IaisE_g_2.unsqueeze(3)
            IaisE_gpre_2 = IaisE_gpre_2.unsqueeze(3)
            IaisE_inlayerpre_2 = IaisE_inlayerpre_2.unsqueeze(3)
            
            mns_2 = torch.cat([mnsF_2, mnsE_2], dim=1)    # [Bx(2xN)]                

            init_exF_2 = exsF_2[...,-1]
            init_exE_2 = exsE_2[...,-1]
            init_IaiF_2 = IaisF_2[...,-1]
            init_IaiE_2 = IaisE_2[...,-1]
            init_mnF_2 = mnsF_2[...,-1]
            init_mnE_2 = mnsE_2[...,-1]
            ...
            emg_2 = self.rdo_mns2emg_2(mns_2) # BxCxT
            
            ##### 230209: Somatosensory feedback
            feedback_2 = self.mns2aff_connection_2(mns_2) ##### v2
            
            fb_Ia_flxs_2, fb_II_flxs_2, fb_Ia_exts_2, fb_II_exts_2 = torch.split(feedback_2, \
                        [self.Ia_neurons_2, self.II_neurons_2, self.Ia_neurons_2, self.II_neurons_2], dim=1)                         
            exs_2 = torch.cat([exsF_2, exsE_2], dim=1) 
            Iais_2 = torch.cat([IaisF_2, IaisE_2], dim=1)
                       
            ##### 230807: Kinematics prediction
            mns_sum = torch.cat([mns, mns_2], dim=1)    # [Bx(2xN)]                            
            kine = self.rdo_mns2kine(mns_sum)
            
            emg = torch.cat([emg, emg_2], dim=1)
            ...
            if t == 0:
                ...
                exsF_stack = torch.zeros(torch.cat((torch.tensor(exsF.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)
                exsE_stack = torch.zeros(torch.cat((torch.tensor(exsE.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)
                IaisF_stack = torch.zeros(torch.cat((torch.tensor(IaisF.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)
                IaisE_stack = torch.zeros(torch.cat((torch.tensor(IaisE.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)
                mnsF_stack = torch.zeros(torch.cat((torch.tensor(mnsF.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)
                mnsE_stack = torch.zeros(torch.cat((torch.tensor(mnsE.shape[:-1]), torch.tensor([n_bin]))).tolist()).to(device)         
            ...
            Ia_flxs_t_stack[..., t_start:t_start+t_bin] = Ia_flxs_t
            II_flxs_t_stack[..., t_start:t_start+t_bin] = II_flxs_t
            Ia_exts_t_stack[..., t_start:t_start+t_bin] = Ia_exts_t
            II_exts_t_stack[..., t_start:t_start+t_bin] = II_exts_t

            IaF2mnF_stack[..., t_start:t_start+t_bin] = IaF2mnF
            IaF2IaiF_stack[..., t_start:t_start+t_bin] = IaF2IaiF
            IIF2exF_stack[..., t_start:t_start+t_bin] = IIF2exF
            IIF2IaiF_stack[..., t_start:t_start+t_bin] = IIF2IaiF
            IaE2mnE_stack[..., t_start:t_start+t_bin] = IaE2mnE
            IaE2IaiE_stack[..., t_start:t_start+t_bin] = IaE2IaiE
            IIE2exE_stack[..., t_start:t_start+t_bin] = IIE2exE
            IIE2IaiE_stack[..., t_start:t_start+t_bin] = IIE2IaiE

            exF2mnF_stack[..., t_start:t_start+t_bin] = exF2mnF
            IaiE2mnF_stack[..., t_start:t_start+t_bin] = IaiE2mnF
            exE2mnE_stack[..., t_start:t_start+t_bin] = exE2mnE
            IaiF2mnE_stack[..., t_start:t_start+t_bin] = IaiF2mnE

            Ia_flxs_stack[..., t_start:t_start+t_bin] = Ia_flxs
            II_flxs_stack[..., t_start:t_start+t_bin] = II_flxs
            Ia_exts_stack[..., t_start:t_start+t_bin] = Ia_exts
            II_exts_stack[..., t_start:t_start+t_bin] = II_exts

            fb_Ia_flxs_stack[..., t_start:t_start+t_bin] = fb_Ia_flxs
            fb_II_flxs_stack[..., t_start:t_start+t_bin] = fb_II_flxs
            fb_Ia_exts_stack[..., t_start:t_start+t_bin] = fb_Ia_exts
            fb_II_exts_stack[..., t_start:t_start+t_bin] = fb_II_exts

            mnsF_inlayer_stack[..., t_start:t_start+t_bin] = mnsF_inlayer
            mnsF_hx_stack[..., t_start:t_start+t_bin] = mnsF_hx
            mnsE_inlayer_stack[..., t_start:t_start+t_bin] = mnsE_inlayer
            mnsE_hx_stack[..., t_start:t_start+t_bin] = mnsE_hx

            mnsF_x_stack[..., t_start:t_start+t_bin] = mnsF_x
            mnsF_g_stack[..., t_start:t_start+t_bin] = mnsF_g
            mnsF_gpre_stack[..., t_start:t_start+t_bin] = mnsF_gpre
            mnsF_inlayerpre_stack[..., t_start:t_start+t_bin] = mnsF_inlayerpre
            mnsE_x_stack[..., t_start:t_start+t_bin] = mnsE_x
            mnsE_g_stack[..., t_start:t_start+t_bin] = mnsE_g
            mnsE_gpre_stack[..., t_start:t_start+t_bin] = mnsE_gpre
            mnsE_inlayerpre_stack[..., t_start:t_start+t_bin] = mnsE_inlayerpre

            exsF_inlayer_stack[..., t_start:t_start+t_bin] = exsF_inlayer
            exsF_hx_stack[..., t_start:t_start+t_bin] = exsF_hx
            exsE_inlayer_stack[..., t_start:t_start+t_bin] = exsE_inlayer
            exsE_hx_stack[..., t_start:t_start+t_bin] = exsE_hx

            exsF_x_stack[..., t_start:t_start+t_bin] = exsF_x
            exsF_g_stack[..., t_start:t_start+t_bin] = exsF_g
            exsF_gpre_stack[..., t_start:t_start+t_bin] = exsF_gpre
            exsF_inlayerpre_stack[..., t_start:t_start+t_bin] = exsF_inlayerpre
            exsE_x_stack[..., t_start:t_start+t_bin] = exsE_x
            exsE_g_stack[..., t_start:t_start+t_bin] = exsE_g
            exsE_gpre_stack[..., t_start:t_start+t_bin] = exsE_gpre
            exsE_inlayerpre_stack[..., t_start:t_start+t_bin] = exsE_inlayerpre

            IaisF_inlayer_stack[..., t_start:t_start+t_bin] = IaisF_inlayer
            IaisF_hx_stack[..., t_start:t_start+t_bin] = IaisF_hx
            IaisE_inlayer_stack[..., t_start:t_start+t_bin] = IaisE_inlayer
            IaisE_hx_stack[..., t_start:t_start+t_bin] = IaisE_hx

            IaisF_x_stack[..., t_start:t_start+t_bin] = IaisF_x
            IaisF_g_stack[..., t_start:t_start+t_bin] = IaisF_g
            IaisF_gpre_stack[..., t_start:t_start+t_bin] = IaisF_gpre
            IaisF_inlayerpre_stack[..., t_start:t_start+t_bin] = IaisF_inlayerpre
            IaisE_x_stack[..., t_start:t_start+t_bin] = IaisE_x
            IaisE_g_stack[..., t_start:t_start+t_bin] = IaisE_g
            IaisE_gpre_stack[..., t_start:t_start+t_bin] = IaisE_gpre
            IaisE_inlayerpre_stack[..., t_start:t_start+t_bin] = IaisE_inlayerpre        
