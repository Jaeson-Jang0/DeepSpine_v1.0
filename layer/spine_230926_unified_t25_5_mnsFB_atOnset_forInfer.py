...
class SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer(nn.Module):
    def __init__(self,
        ...
        super(SpinalCordCircuit_230926_unified_t25_5_mnsFB_atOnset_forInfer, self).__init__()
        
        self.ini_kine = np.array(ini_kine, dtype=np.dtype('d')) ##### forInfer
...
#         y_pred = kine_stack[:,0,22] - kine_stack[:,0,18]
        y_pred = kine_stack[:,:,22] - kine_stack[:,:,18]
