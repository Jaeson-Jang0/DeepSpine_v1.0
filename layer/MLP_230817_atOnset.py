# revised from 'MLP_230726_noFB': To test MLP compared to spine_230817
...
class MLP_230817_atOnset(nn.Module):
    ...
    def __init__(self,
        ...
        super(MLP_230817_atOnset, self).__init__()
...
#             self.output_norm = None
        ...
        self.rdo_mns2kine = CausalConv1d(rdo_in_channels, rdo_out_channels, kernel_size=rdo_kernel_size, groups=rdo_groups, pad=rdo_kernel_size-1) ##### 230823
...
#         t0 = 500
        ...
        for t in range(n_bin): ##### t25
            ...
            ##### 230309
            if t > int(t_bin/t_int) - 1: ##### 230823, 230718, t25
                kinematics_bin_fb = torch.cat((torch.tile(kine_stack[:,:,t-2:t-1], (1,1,t_int)), torch.tile(kine_stack[:,:,t-1:t], (1,1,t_int))), dim=2) ##### 230718
            ...
            if t == 0:
                ...
                afferents_t = afferents_kine + feedback
