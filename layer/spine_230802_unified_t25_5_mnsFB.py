...
class SpinalCordCircuit_230802_unified_t25_5_mnsFB(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230802_unified_t25_5_mnsFB, self).__init__()
...
#         self.rdo_emg2kine = CausalConv1d(rdo_emg_channels, rdo_out_channels, kernel_size=rdo_kernel_size, groups=rdo_groups, pad=rdo_kernel_size-1)
        self.rdo_mns2kine = CausalConv1d(rdo_in_channels, rdo_out_channels, kernel_size=rdo_kernel_size, groups=rdo_groups, pad=rdo_kernel_size-1)
