...
class SpinalCordCircuit_230605_simpleAct_synthetic(nn.Module):
    def __init__(self,
            emb_in_channels,
            emb_out_channels,
            emb_kernel_size,
        ...
        super(SpinalCordCircuit_230605_simpleAct_synthetic, self).__init__()
...
#             print('In layer: ', kinematics_bin.shape)
...
#             II_exts_t = torch.mean(II_exts_t, dim=2, keepdim=True)
            ...
            if t == 0:
                ...
                #### 230523
#                 print("t = ", t, Ia_flxs_t_stack.shape, Ia_flxs_t.shape)
